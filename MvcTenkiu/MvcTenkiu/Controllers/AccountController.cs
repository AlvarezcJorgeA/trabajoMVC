...
namespace MvcTenkiu.Controllers
{
    ...
    {
        CustomMembershipProvider CustomProvider = new CustomMembershipProvider();
        //
        // GET: /Account/Login
        ...
        {
            if (ModelState.IsValid && CustomProvider.ValidateUser(model.UserName, model.Password))
            {
        ...
        public ActionResult Register(RegisterModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                try
                {
                    CustomProvider.CreateUser(model.UserName, model.Password);
                    return RedirectToAction("Index", "Home");
                }
